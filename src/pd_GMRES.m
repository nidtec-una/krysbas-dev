%modificado por jccf octurbe 2018
%
%This is a basic PD-GMRES program with restart
%Inputs include A, x0, b, minitial, mmin, mmax,  mstep, tol, alpha, delta.
% 
%clear all
function [tiempoC, logres]=pd_GMRES(A,b, mPD, alpha, delta,itermax)
